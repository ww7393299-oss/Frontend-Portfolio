...
const projects = [
  {
    name: "Somani Plywood Agencies",
    tech: "UI/UX + Product Showcase",
    thumbnail: "/assets/website.png",
    github: "https://somani-plywood.netlify.app/",
  },
  {
    name: "Clash AI",
    tech: "Personal AI Assistant",
    thumbnail: "/assets/website.png",
    github: "https://github.com/ww7393299-oss/CLASH-AI",
  },
  {
    name: "Bellano Sneaker",
    tech: "Frontend + UI/UX",
    thumbnail: "/assets/website.png",
    github: "https://github.com/ww7393299-oss/bellano-sneaker",
  },
];
  ...
  return (
    ...
    >
      <div className="relative h-48 overflow-hidden bg-white/5">
        ...
        <span className="absolute bottom-3 left-4 text-sm font-semibold text-white tracking-wide">
          {item.name}
        </span>
      </div>
